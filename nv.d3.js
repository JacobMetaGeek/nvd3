...
nv.models.stackedAreaPlusLineChart = function() {
  "use strict";
  //============================================================
  // Public Variables with Default Settings
  //------------------------------------------------------------
  ...
  function chart(selection) {
    selection.each(function(data) {
      ...
      var wrap = container.selectAll('g.nv-wrap.nv-stackedAreaPlusLineChart').data([data]);
      var gEnter = wrap.enter().append('g').attr('class', 'nvd3 nv-wrap nv-stackedAreaPlusLineChart').append('g');
      var g = wrap.select('g');
  ...
  d3.rebind(chart, stacked, lines, 'x', 'y', 'size', 'xScale', 'yScale', 'xDomain', 'yDomain', 'xRange', 'yRange', 'sizeDomain', 'interactive', 'useVoronoi', 'offset', 'order', 'style', 'clipEdge', 'forceX', 'forceY', 'forceSize', 'interpolate');
